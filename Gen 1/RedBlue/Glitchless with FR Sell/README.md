...
**Silph Rival:**
- Pidgeot: S3 X Accuracy + d12 X Speed (HM01 delays) + U1 X Special + HD
- Gyarados: ... + HD
...
- Growlithe: ... + BB
    - **19-25**:
        - @+1: **X Special** (3 below HM01 or U4 from Flute)
        - @+2: **Flute** (2 below HM02)
- Alakazam: ... + HD
    - **46-51**: **-- X Special**
    - **38-45**: **U7 Potion** (HM01 exits)
- Venu: HD
...
**Snorlax Menu**:
- s3 **Super Repel** + d2 swap Parlyz Heal, d11 w/ **Rare Candy** (2 below X Speed)
- d1 use **Poke Flute**
